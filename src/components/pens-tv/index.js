    ...
    return(
        <div className="static block">
            <div className="absolute flex flex-col w-2/3 h-screen px-16 pt-[150px] bg-[#103968]">
                ...
                <button className="flex w-[300px] bg-yellow-400 shadow-lg shadow-zinc-800 justify-center items-center ml-20 mt-10 py-4 text-white text-lg font-semibold uppercase tracking-widest">subscribe now</button>
            </div>
