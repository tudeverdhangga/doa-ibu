                ...
                <div className="flex lg:flex-row flex-col items-center w-full h-full justify-center align-center md:mr-20">
                    <ScrollAnimation animateOnce={true} animateIn="animate__fadeInLeft" className="animate__animated">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="font-roboto font-light text-white text-lg lg:ml-20 w-1/2 mt-5">PENS TV merupakan program video jurnalistik yang menginformasikan berita terbaru seputar PENS seperti kegiatan kampus, kompetisi, acara besar, dan hal-hal seputar PENS lainnya.</p>
                            <button className="flex w-[220px] xl:w-[300px] bg-yellow-400 shadow-lg shadow-zinc-800 justify-center items-center lg:ml-24 mt-10 py-4 text-white text-lg font-semibold uppercase tracking-widest hover:-translate-y-1 hover:scale-110 transition ease-in-out duration-300">
